...
export const useApp = () => {
  ...
  return {
    ...
    addEpic: ppm.addEpic,
    updateEpic: ppm.updateEpic,
    deleteEpic: ppm.deleteEpic,
    addRelease: ppm.addRelease,
    updateRelease: ppm.updateRelease,
    deleteRelease: ppm.deleteRelease,
    updateTask: ppm.updateTask,
    addDiscussionComment: ppm.addDiscussionComment,
    sprints: [],
    comments: [],
