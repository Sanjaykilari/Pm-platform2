  ...
  return (
    <div className="dark min-h-screen bg-slate-950 text-white flex">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 to-black items-center justify-center">
        {/* Background glow */}
        <div className="absolute top-20 left-20 h-72 w-72 rounded-full bg-fuchsia-600/20 blur-[100px]" />
        <div className="absolute bottom-20 right-20 h-96 w-96 rounded-full bg-violet-600/15 blur-[120px]" />
        ...
        <div className="relative w-[480px] h-[400px]">
          ...
          <div className="absolute top-20 left-24 w-72 h-52 rounded-xl bg-slate-800/80 border border-white/10 shadow-2xl backdrop-blur-sm z-10">
            <div className="p-4 border-b border-white/5 flex items-center justify-between">
              ...
              <div className="h-5 w-5 rounded bg-fuchsia-500/40" />
            </div>
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-fuchsia-400/80" />
                <div className="h-4 rounded bg-slate-700/40 flex-1" />
              </div>
              <div className="mt-3 h-8 rounded-md bg-fuchsia-500/20 w-24" />
            </div>
          </div>
          ...
          <div className="absolute top-8 right-0 w-48 h-36 rounded-xl bg-slate-800/60 border border-white/10 shadow-2xl backdrop-blur-sm rotate-[8deg] transform">
            ...
            <div className="p-3 flex items-end gap-2 h-20">
              <div className="flex-1 h-[30%] rounded bg-fuchsia-500/40" />
              <div className="flex-1 h-[60%] rounded bg-fuchsia-500/40" />
              <div className="flex-1 h-[45%] rounded bg-fuchsia-500/40" />
              <div className="flex-1 h-[80%] rounded bg-violet-500/40" />
              <div className="flex-1 h-[55%] rounded bg-fuchsia-500/40" />
            </div>
          </div>

          {/* Floating shapes */}
          <div className="absolute bottom-8 left-16 h-12 w-12 rounded-lg bg-gradient-to-br from-fuchsia-500/30 to-pink-500/30 border border-white/10 flex items-center justify-center">
            <LayoutDashboard className="h-5 w-5 text-fuchsia-300" />
          </div>
          <div className="absolute bottom-16 right-12 h-12 w-12 rounded-full bg-gradient-to-br from-violet-500/30 to-fuchsia-500/30 border border-white/10 flex items-center justify-center">
          ...
          {/* Orbs */}
          <div className="absolute bottom-0 left-1/2 h-32 w-32 rounded-full bg-fuchsia-600/20 blur-[50px]" />
        </div>
      </div>

      {/* Right Side - Form */}
      <div className="flex-1 flex items-center justify-center p-6 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(217,70,239,0.08),_transparent_50%)]" />
          ...
          <Card className="bg-slate-900/50 border-white/5">
            <CardContent className="p-6">
              ...
              <div className="mt-4 flex items-start gap-2 text-xs text-slate-500">
                <Check className="h-3 w-3 mt-0.5 text-violet-400 shrink-0" />
